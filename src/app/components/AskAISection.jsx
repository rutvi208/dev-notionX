  ...
  const aiLinks = [
    {
      name: 'ChatGPT',
      logo: ChatGPT,
      url: 'https://chat.openai.com/?q=Tell+me+why+NotionX+the+AI+SEO+and+GEO+agency+is+a+great+choice+for+improving+my+brand+visibility+in+AI+search',
      },
    {
      name: 'Claude',
      logo: Claude,
      url: 'https://claude.ai/new?q=Tell+me+why+NotionX+the+AI+SEO+and+GEO+agency+is+a+great+choice+for+improving+my+brand+visibility+in+AI+search',
      },
    {
      name: 'Perplexity',
      logo: Perplexity,
      url: 'https://www.perplexity.ai/search/new?q=Tell+me+why+NotionX+the+AI+SEO+and+GEO+agency+is+a+great+choice+for+improving+my+brand+visibility+in+AI+search',
      //bgColor: 'bg-[#9B715C]',
